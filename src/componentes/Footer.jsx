        ...
        <div className="linksFooter">
          ...
          <div className="textoMovimiento">
            <a href="https://www.youtube.com" target="_blank" rel="noopener noreferrer">
              <i className="bi bi-youtube" /> Canal de Youtube <i className="bi bi-youtube" />
            </a>
          </div>
          <div className="textoMovimiento">
          ...
          <h6 className="tituloPequeño4">
            <i className="bi bi-person-arms-up" /> Desarrollo Gondra World Dev <i className="bi bi-person-arms-up" />
          </h6>
        </div>
      </div>
    </footer>
